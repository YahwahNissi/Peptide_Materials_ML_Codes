...
if savefig:
    plt.savefig('/shared/peptide/final_model_training/plots/fulldata_gpr_v2',bbox_inches='tight',dpi=300)
...
import json
with open("fulldata_gpr_v2_sel_features.json", "w") as f:
    json.dump(f_dict , f) 
...
with open('/shared/peptide/final_model_training/models/fulldata_gpr_v2','wb') as f: #file name
